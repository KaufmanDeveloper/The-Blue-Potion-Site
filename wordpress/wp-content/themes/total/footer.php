		...
		<div id="ht-bottom-footer">
			<div class="ht-container">
				<div class="ht-site-info">
					<?php printf( esc_html__( 'WordPress Theme', 'Michael Kaufman' ) ); ?>
					<span class="sep"> | </span>
					<?php printf( esc_html__( '%1$s by %2$s', 'total' ), '<a href="http://thebluepotion.com" target="_blank">Home Page</a>', 'Michael Kaufman' ); ?>
				</div><!-- #site-info -->
			</div>
		</div>
	</footer><!-- #colophon -->
